...
class Level1Controller: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let workEnglish = Section(title: "Work English", objects: ["Networking", "The Virtual Classroom", "Schedules"],icon: "IconLessons", storyBoard: "VideoView")
        let lifeEnglish = Section(title: "Life English", objects: ["Family", "Free Time", "Future Events"],icon: "IconLessons", storyBoard: "VideoView")
