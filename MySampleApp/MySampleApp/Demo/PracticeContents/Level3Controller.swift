...
class Level3Controller: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let workEnglish = Section(title: "Work English", objects: ["Business Travel", "Project Management", "Production","Presentations","Presentations 2","Quality","Advising","Equipment","New Model"],icon: "IconLessons", storyBoard: "VideoView")
        let lifeEnglish = Section(title: "Life English", objects: ["Personal Travel", "Traffic", "Housing","Housing 2","Shopping","Crime","Schools","Health","Services & Agreements"],icon: "IconLessons", storyBoard: "VideoView")
