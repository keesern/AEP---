...
class Level5Controller: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let workEnglish = Section(title: "Work English", objects: ["Advising", "Budgets", "Meetings"," Presentations","Production","Purchasing","Equipment","Quality","New Model"],icon: "IconLessons", storyBoard: "VideoView")
        let lifeEnglish = Section(title: "Life English", objects: ["Shopping", "Services & Agreements", "Health","Emergencies","Crime","Traffic","Fast Food","Dining Out","Schools"],icon: "IconLessons", storyBoard: "VideoView")
