...
class AWSCUPIdPSignInProvider: NSObject, AWSSignInProvider {
    ...
    func completeLogin() {
        ...
        self.imageURL = NSURL(string: "https://qph.ec.quoracdn.net/main-qimg-32789663a2decb28728409180650e057?convert_to_webp=true") // temporary place holder - should load user image
